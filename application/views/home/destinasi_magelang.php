        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="section_title text-center mb_70">
                    <h3>Paket Wisata</h3>
                    <p>Jelajahi keindahan Indonesia bersama kami! Nikmati pesona alam dan budaya dengan paket wisata eksklusif ke tiga destinasi favorit Karimunjawa, Magelang dan Dieng. 
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <?php else: ?>
                <div class="col-12">
                    <div class="alert alert-info text-center mt-4">
                        Tidak ada paket wisata Magelang tersedia saat ini.
                    </div>
                </div>
            <?php endif; ?>
        </div>
